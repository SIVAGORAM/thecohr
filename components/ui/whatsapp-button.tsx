  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      <a
        ...
        aria-label="Chat with The Co HR on WhatsApp"
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-lg shadow-emerald-500/30 transition-all duration-300 hover:scale-110 active:scale-95"
      >
