...
const stageIcons: Record<string, React.ReactNode> = {
  attract: <Users className="w-5 h-5 text-[#0066FF]" />,
  hire: <UserPlus className="w-5 h-5 text-[#0066FF]" />,
  onboard: <UserCheck className="w-5 h-5 text-[#0066FF]" />,
  attendance: <CalendarCheck className="w-5 h-5 text-[#0066FF]" />,
  leave: <CalendarDays className="w-5 h-5 text-[#0066FF]" />,
  payroll: <CreditCard className="w-5 h-5 text-[#0066FF]" />,
  performance: <TrendingUp className="w-5 h-5 text-[#0066FF]" />,
  learning: <GraduationCap className="w-5 h-5 text-[#0066FF]" />,
  leverage: <Settings className="w-5 h-5 text-[#0066FF]" />,
  engagement: <Heart className="w-5 h-5 text-[#0066FF]" />,
  offboarding: <UserMinus className="w-5 h-5 text-[#0066FF]" />,
  growth: <Rocket className="w-5 h-5 text-[#0066FF]" />
};
...
function StageCard({ stage }: { stage: { name: string; description: string; icon: string } }) {
  return (
    <div className="flex flex-col items-center shrink-0 w-[110px] text-center group">
      {/* Icon Card Box */}
      <div className="w-12 h-12 rounded-xl bg-white border-2 border-blue-100/90 group-hover:border-[#0066FF] group-hover:shadow-[0_4px_20px_rgba(0,102,255,0.18)] flex items-center justify-center shadow-sm transition-all duration-300 transform group-hover:-translate-y-0.5">
        {stageIcons[stage.icon]}
      </div>

      {/* Stage Name & Subtitle */}
      <div className="mt-2.5 space-y-0.5">
        <span className="text-[12px] font-bold text-[#051332] block leading-tight group-hover:text-[#0066FF] transition-colors">
          {stage.name}
        </span>
  ...
  return (
    <div className="h-12 flex items-center justify-center shrink-0 px-2 sm:px-3">
      <div className="relative flex items-center justify-center w-12 sm:w-16">
        ...
        <div className="w-full h-0 border-t-2 border-dashed border-[#0066FF]/35" />
        ...
        <div className="absolute flex items-center gap-1.5">
          ...
          <div className="w-2 h-2 rounded-full bg-[#0066FF] shadow-[0_0_8px_rgba(0,102,255,0.7)] animate-pulse" />
          <div className="w-1.5 h-1.5 rounded-full bg-[#0066FF]/30" />
        </div>
      </div>
    </div>
      ...
      <div className="mx-auto max-w-[1500px] px-6 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 relative">
          <FadeIn direction="up" className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-[11px] sm:text-xs font-bold tracking-[0.2em] text-[#0066FF] uppercase">
              {eyebrow}
            </span>
            <div className="h-[1px] w-12 sm:w-16 bg-[#BFDBFE]" />
          </FadeIn>
          ...
          <FadeIn direction="up" delay={0.1} className="text-[32px] sm:text-[38px] lg:text-[44px] font-heading font-bold text-[#051332] tracking-tight mb-4">
            <h2>
              From Hire to <span className="italic text-[#0066FF]">Higher Potential</span>
            </h2>
          </FadeIn>
          ...
          <div className="absolute top-0 right-0 lg:-right-36 xl:-right-48 text-[#0066FF] text-[20px] lg:text-[26px] leading-snug hidden md:block font-[family-name:var(--font-playball)] drop-shadow-sm pointer-events-none -rotate-6">
            People<br />
            Perform<br />
            Progress
          </div>
