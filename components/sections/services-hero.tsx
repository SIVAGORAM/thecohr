        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <FadeIn direction="right" duration={0.6} className="lg:col-span-7 space-y-4 sm:space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-[46px] font-extrabold text-[#051332] tracking-tight leading-[1.15]">
              ...
              <span className="text-[#1E90FF]">Complete HR Solutions.</span>
            </h1>
            ...
            <div className="pt-3 flex flex-wrap items-center gap-2.5 sm:gap-4">
              ...
              <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm px-4 py-2.5 rounded-full border border-blue-100 shadow-sm shrink-0">
                <div className="w-9 h-9 rounded-full bg-blue-100/80 flex items-center justify-center text-[#1E90FF] shrink-0">
          ...
          <FadeIn direction="left" duration={0.6} delay={0.1} className="lg:col-span-5 relative flex items-center justify-end">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-blue-100/80 bg-white max-w-[560px] w-full">
              ...
              <div className="absolute top-3 right-4 sm:top-5 sm:right-6 z-20 pointer-events-none transform -rotate-3 hidden sm:block">
                <span className="block text-2xl sm:text-3xl lg:text-[32px] text-[#1E90FF] font-normal font-[family-name:var(--font-playball)] leading-tight drop-shadow-sm">
                  People<br />
                  Performance<br />
                  Possibilities
                </span>
                <svg className="w-20 sm:w-24 h-4 text-[#1E90FF] opacity-80 mt-0.5" viewBox="0 0 100 12" fill="none">
              ...
              <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-lg border border-blue-50 px-3 py-2 sm:px-4 sm:py-3 flex items-center gap-2.5 sm:gap-3 max-w-[190px] sm:max-w-[240px] z-20">
                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-blue-100/80 flex items-center justify-center text-[#1E90FF] shrink-0">
